export const en = {
  ...
  COMMISSION_RIB_INVALID: 'Bank details are invalid.',
  COMMISSION_RIB_REQUIRED: 'Please provide bank details before enabling bank transfer.',
  COMMISSION_RIB_DISABLED: 'Bank transfer is disabled.',
  COMMISSION_RIB_UNAVAILABLE: 'Bank details are not available.',
  COMMISSION_RIB_TITLE: 'Bank account details',
  COMMISSION_RIB_ACCOUNT_HOLDER: 'Account holder',
  COMMISSION_RIB_BANK_NAME: 'Bank',
  COMMISSION_RIB_BANK_ADDRESS: 'Bank address',
  COMMISSION_RIB_IBAN: 'IBAN',
  COMMISSION_RIB_BIC: 'BIC/SWIFT',
  COMMISSION_RIB_ACCOUNT_NUMBER: 'Account number / RIB',
  COMMISSION_RIB_INSTRUCTIONS: 'Payment instructions',
}
