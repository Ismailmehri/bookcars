export const en = {
  ...
  COMMISSION_SUPPLIER_SUBJECT: 'Reminder: commission due for booking %{bookingId}',
  COMMISSION_SUPPLIER_MESSAGE: 'Please update the status of booking %{bookingId} and settle the associated commission.',
  COMMISSION_SUPPLIER_ACTION: 'Open booking',
  COMMISSION_CLIENT_SUBJECT: 'Reminder: booking %{bookingId} follow-up',
  COMMISSION_CLIENT_MESSAGE: 'Please confirm your booking %{bookingId} with the agency so we can close the commission.',
  COMMISSION_CLIENT_ACTION: 'Contact the agency',
