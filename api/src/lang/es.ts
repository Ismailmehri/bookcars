export const es = {
  ...
  BOOKING_STATUS_CANCELLED: 'Annulée',
    ...
    COMMISSION_SUPPLIER_SUBJECT: 'Recordatorio: comisión pendiente para la reserva %{bookingId}',
    COMMISSION_SUPPLIER_MESSAGE: 'Actualiza el estado de la reserva %{bookingId} y liquida la comisión correspondiente.',
    COMMISSION_SUPPLIER_ACTION: 'Abrir reserva',
    COMMISSION_CLIENT_SUBJECT: 'Recordatorio: seguimiento de la reserva %{bookingId}',
    COMMISSION_CLIENT_MESSAGE: 'Confirma tu reserva %{bookingId} con la agencia para que podamos cerrar la comisión.',
    COMMISSION_CLIENT_ACTION: 'Contactar con la agencia',
