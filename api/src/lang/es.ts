export const es = {
  ...
  BOOKING_STATUS_CANCELLED: 'Annulée',
    ...
    COMMISSION_RIB_INVALID: 'Los datos bancarios no son válidos.',
    COMMISSION_RIB_REQUIRED: 'Proporcione los datos bancarios antes de habilitar la transferencia.',
    COMMISSION_RIB_DISABLED: 'La transferencia bancaria está desactivada.',
    COMMISSION_RIB_UNAVAILABLE: 'Los datos bancarios no están disponibles.',
    COMMISSION_RIB_TITLE: 'Datos bancarios',
    COMMISSION_RIB_ACCOUNT_HOLDER: 'Titular de la cuenta',
    COMMISSION_RIB_BANK_NAME: 'Banco',
    COMMISSION_RIB_BANK_ADDRESS: 'Dirección del banco',
    COMMISSION_RIB_IBAN: 'IBAN',
    COMMISSION_RIB_BIC: 'BIC/SWIFT',
    COMMISSION_RIB_ACCOUNT_NUMBER: 'Número de cuenta / RIB',
    COMMISSION_RIB_INSTRUCTIONS: 'Instrucciones de pago',
  }
