export const fr = {
  ...
  COMMISSION_SUPPLIER_SUBJECT: 'Rappel : commission due pour la réservation %{bookingId}',
  COMMISSION_SUPPLIER_MESSAGE: 'Merci de mettre à jour la réservation %{bookingId} et de régler la commission associée.',
  COMMISSION_SUPPLIER_ACTION: 'Ouvrir la réservation',
  COMMISSION_CLIENT_SUBJECT: 'Rappel : suivi de votre réservation %{bookingId}',
  COMMISSION_CLIENT_MESSAGE: 'Merci de confirmer votre réservation %{bookingId} auprès de l’agence afin de clôturer la commission.',
  COMMISSION_CLIENT_ACTION: 'Contacter l’agence',
