export const fr = {
  ...
  BOOKING_PAY_LATER_NOTIFICATION: ' vient de réserver une voiture pour {{days}} jours (Total : {{price}} DT). Veuillez vérifier et traiter la demande rapidement.',
  BOOKING_PAID_NOTIFICATION: ' a payé une réservation de {{days}} jours (Total : {{price}} DT). Veuillez vérifier les détails.',
  ...
  COMMISSION_RIB_INVALID: 'Les informations RIB sont invalides.',
  COMMISSION_RIB_REQUIRED: 'Veuillez renseigner le RIB avant d’activer le virement bancaire.',
  COMMISSION_RIB_DISABLED: 'Le virement bancaire est désactivé.',
  COMMISSION_RIB_UNAVAILABLE: 'Les informations RIB ne sont pas disponibles.',
  COMMISSION_RIB_TITLE: 'Coordonnées bancaires',
  COMMISSION_RIB_ACCOUNT_HOLDER: 'Titulaire du compte',
  COMMISSION_RIB_BANK_NAME: 'Banque',
  COMMISSION_RIB_BANK_ADDRESS: 'Adresse de la banque',
  COMMISSION_RIB_IBAN: 'IBAN',
  COMMISSION_RIB_BIC: 'BIC/SWIFT',
  COMMISSION_RIB_ACCOUNT_NUMBER: 'Numéro de compte / RIB',
  COMMISSION_RIB_INSTRUCTIONS: 'Instructions de paiement',
}
