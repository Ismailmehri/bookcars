export const fr = {
  ...
  COMMISSION_REMINDER_SUPPLIER_SUBJECT: 'Rappel : commission en attente',
  COMMISSION_REMINDER_SUPPLIER_BODY: 'Ceci est un rappel concernant la commission de la réservation %{booking}. Merci de vous connecter sur Plany pour vérifier et régler le paiement.',
  COMMISSION_REMINDER_CLIENT_SUBJECT: 'Rappel : suivi de réservation',
  COMMISSION_REMINDER_CLIENT_BODY: 'Ceci est un rappel concernant votre réservation %{booking}. Notre équipe vous contactera si des informations complémentaires sont nécessaires.',
