...
const strings = new LocalizedStrings({
  fr: {
    ...
    RESEND: 'Renvoyer',
    NOT_ACTIVATED_MAIL: "Votre compte est en attente d'activation par un administrateur. Merci de patienter.",
    RESEND_ACTIVATION: "Renvoyer une demande d'activation.",
