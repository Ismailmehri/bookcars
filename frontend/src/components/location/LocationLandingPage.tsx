...
const LocationLandingPage: React.FC<LocationLandingPageProps> = ({
  ...
  const breadcrumbs = useMemo(
    () => [
      { label: 'Accueil', href: '/' },
      { label: `Location voiture ${city}`, href: slug },
    ],
    [city, slug]
  )
  ...
  const defaultJsonLd = useMemo(() => {
    ...
    const breadcrumbSchema = buildBreadcrumbSchema(city, canonicalUrl)
    return [localBusinessSchema, faqSchema, offerCatalogSchema, breadcrumbSchema]
  ...
  const sectionAnchors = useMemo(
    () => ({
      ...
      advantages: 'section-location-advantages',
      nearby: 'section-location-nearby',
      vehicles: 'section-location-vehicles',
      suppliers: 'section-location-suppliers',
      map: 'section-location-map',
      stats: 'section-location-stats',
      faq: 'section-location-faq',
      howItWorks: 'section-location-how-it-works',
      cta: 'section-location-cta',
      seoNote: 'section-location-seo-note',
      rentalAgency: 'section-location-rental-agency',
    }),
    []
  )
  ...
  return (
    <Layout strict={false}>
      ...
      <Box component="main">
        ...
        >
          <Container maxWidth="lg">
            <Stack spacing={3} alignItems="center" textAlign="center">
              <Box sx={{ width: '100%', alignSelf: { xs: 'stretch', md: 'flex-start' } }}>
                <nav aria-label="Fil d'Ariane">
                  <Breadcrumbs sx={{ color: 'rgba(255,255,255,0.85)' }} separator="/">
                    {breadcrumbs.map((crumb) => (
                      <Link key={crumb.href} href={crumb.href} color="inherit" underline="hover">
                        {crumb.label}
                      </Link>
                    ))}
                  </Breadcrumbs>
              ...
              <Typography variant="h5" component="p" sx={{ fontWeight: 500, opacity: 0.9 }}>
                {hero.subheading}
              </Typography>
        ...
        <Box
          component="section"
          id={sectionAnchors.nearby}
          aria-labelledby="location-nearby-heading"
          sx={{ backgroundColor: '#f5f8fb', py: { xs: 6, md: 8 } }}
        >
          <Container maxWidth="lg">
            <Typography
              id="location-nearby-heading"
              variant="h4"
              component="h2"
            ...
            <Typography variant="body1" component="p" sx={{ color: 'text.secondary', mb: 4, maxWidth: 720 }}>
              {nearbyIntro}
            </Typography>
        ...
        <Container
          component="section"
          id={sectionAnchors.vehicles}
          aria-labelledby="location-vehicles-heading"
          maxWidth="lg"
          sx={{ py: { xs: 6, md: 8 } }}
        >
          <Typography
            id="location-vehicles-heading"
            variant="h4"
            component="h2"
            sx={{ fontWeight: 700, mb: 1.5 }}
          >
        ...
        <Box
          component="section"
          id={sectionAnchors.suppliers}
          aria-labelledby="location-suppliers-heading"
          sx={{ backgroundColor: '#0f172a', color: 'white', py: { xs: 6, md: 8 } }}
        >
          <Container maxWidth="lg">
            <Typography
              id="location-suppliers-heading"
              variant="h4"
              component="h2"
              sx={{ fontWeight: 700, textAlign: 'center', mb: 1.5 }}
            >
        ...
        <Box
          component="section"
          id={sectionAnchors.map}
          aria-labelledby="location-map-heading"
          sx={{ py: { xs: 6, md: 8 }, backgroundColor: '#f5f8fb' }}
        >
          <Container maxWidth="lg">
            <Typography
        ...
        <Container
          component="section"
          id={sectionAnchors.stats}
          aria-labelledby="location-stats-heading"
          maxWidth="lg"
          sx={{ py: { xs: 6, md: 8 } }}
        >
          <Typography
        ...
        <Box
          component="section"
          id={sectionAnchors.faq}
          aria-labelledby="location-faq-heading"
          sx={{ backgroundColor: '#f9fafc', py: { xs: 6, md: 8 } }}
        >
          <Container maxWidth="md">
            ...
            <Typography variant="body1" component="p" sx={{ textAlign: 'center', color: 'text.secondary', mb: 4 }}>
              {faqIntro}
            </Typography>
        ...
        <Container
          component="section"
          id={sectionAnchors.howItWorks}
          aria-labelledby="location-how-heading"
          maxWidth="lg"
          sx={{ py: { xs: 6, md: 8 } }}
        >
          <HowItWorks headingId="location-how-heading" />
        </Container>
          ...
          >
            <Stack spacing={3} alignItems="center">
              ...
              <Typography
                variant="body1"
                component="p"
                sx={{ textAlign: 'center', color: 'text.secondary', maxWidth: 680 }}
              >
                {cta.description}
              </Typography>
        ...
        <Container
          component="section"
          id={sectionAnchors.seoNote}
          aria-labelledby="location-seo-note-heading"
          maxWidth="md"
          sx={{ py: { xs: 4, md: 5 } }}
        >
          <Paper elevation={1} sx={{ p: { xs: 3, md: 4 }, borderRadius: 3 }}>
            <Typography
              id="location-seo-note-heading"
              variant="body2"
              component="p"
        ...
        <Container
          component="section"
          id={sectionAnchors.rentalAgency}
          aria-labelledby="location-rental-agency-heading"
          maxWidth="lg"
          sx={{ py: { xs: 6, md: 8 } }}
        >
          <RentalAgencySection headingId="location-rental-agency-heading" />
        </Container>
