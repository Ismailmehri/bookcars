...
const env = {
  ...
  FACEBOOK_PIXEL_ENABLED:
    (import.meta.env.VITE_BC_FACEBOOK_PIXEL_ENABLED && import.meta.env.VITE_BC_FACEBOOK_PIXEL_ENABLED.toLowerCase()) === 'true',
  FACEBOOK_PIXEL_ID: String(import.meta.env.VITE_BC_FACEBOOK_PIXEL_ID || ''),
  FACEBOOK_PIXEL_CURRENCY: String(import.meta.env.VITE_BC_FACEBOOK_PIXEL_CURRENCY || 'TND'),
