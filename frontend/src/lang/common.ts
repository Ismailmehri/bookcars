...
const strings = new LocalizedStrings({
  fr: {
    ...
    ERROR_EXPLANATION: 'Un incident est survenu. Merci de réessayer ou de revenir à l’accueil.',
    TRY_AGAIN: 'Réessayer',
    ...
    LOADING: 'Chargement...',
    META_EVENT_SENDING: 'Envoi sécurisé des données...',
    META_EVENT_ERROR: "Échec de l'envoi des données de suivi. Une nouvelle tentative aura lieu sous peu.",
  ...
  en: {
    ...
    ERROR_EXPLANATION: 'Something went wrong. Please try again or return home.',
    TRY_AGAIN: 'Try again',
    FULL_NAME: 'Full name',
    EMAIL: 'Email',
    PASSWORD: 'Password',
    ...
    LOADING: 'Loading...',
    META_EVENT_SENDING: 'Sending analytics data securely...',
    META_EVENT_ERROR: 'We could not send tracking data. Another attempt will run shortly.',
  ...
  es: {
    ...
    ERROR_EXPLANATION: 'Ha ocurrido un incidente. Vuelva a intentarlo o regrese al inicio.',
    ...
    LOADING: 'Cargando...',
    META_EVENT_SENDING: 'Enviando datos de analítica de forma segura...',
    META_EVENT_ERROR: 'No se pudieron enviar los datos de seguimiento. Se intentará de nuevo en breve.',
