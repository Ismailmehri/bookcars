...
const strings = new LocalizedStrings({
  fr: {
    ...
    EMPTY_LOCATIONS: 'Aucune destination prioritaire disponible pour le moment.',
    RENT_PREFIX: 'Location voiture à',
  },
  en: {
    COPYRIGHT_PART1,
    ...
    RETRY: 'Retry',
    ERROR: 'Unable to load featured locations',
    EMPTY_LOCATIONS: 'No highlighted destinations are available right now.',
    RENT_PREFIX: 'Car rental in',
  },
  es: {
    COPYRIGHT_PART1,
    ...
    EMPTY_LOCATIONS: 'No hay destinos destacados por ahora.',
    RENT_PREFIX: 'Alquiler de coche en',
  },
})
