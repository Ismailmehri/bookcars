...
const autoRentalJsonLd = {
  ...
  description,
  areaServed: 'Hammamet',
  url: 'https://plany.tn/location-voiture-pas-cher-a-hammamet',
...
const LocationAHammamet: React.FC = () => (
  <Container component="main" sx={{ py: 4 }}>
    ...
    <Typography variant="body1" paragraph>
      Préparez votre escapade au Cap Bon : remplissez le SearchForm Plany, choisissez votre voiture à Hammamet et vivez vos vacances en toute sérénité.
    </Typography>
  </Container>
)
