...
locationDataSEO.sfax = {
  ...
  nearbyDestinations: nearbyFactory('Sfax', [
    {
      name: 'Gabès',
      image: '/location-voiture-gabes.webp',
      imageAlt: 'Location voiture Gabès avec Plany.tn – oasis maritime et souks',
...
locationDataSEO.djerba = {
  ...
  nearbyDestinations: nearbyFactory('Djerba', [
    ...
    },
    {
      ...
      imageAlt: 'Location voiture Midoun avec Plany.tn – plages et souks de Djerba',
...
locationDataSEO['ben-arous'] = {
  ...
  nearbyDestinations: nearbyFactory('Ben Arous', [
    ...
    },
    {
      name: 'Radès',
      image: '/cover.webp',
      imageAlt: 'Location voiture Radès avec Plany.tn – marina et front de mer',
...
locationDataSEO.bizerte = {
  ...
  nearbyDestinations: nearbyFactory('Bizerte', [
    ...
    },
    {
      name: 'Cap Serrat',
      image: '/cover.webp',
      imageAlt: 'Location voiture Cap Serrat avec Plany.tn – criques et falaises',
      link: '/location-voiture-pas-cher-a-bizerte',
...
locationDataSEO.gafsa = {
  ...
  nearbyDestinations: nearbyFactory('Gafsa', [
    ...
    },
    {
      name: 'Métlaoui',
      image: '/cover.webp',
      imageAlt: 'Location voiture Métlaoui avec Plany.tn – gorges et train Lézard Rouge',
  ...
  nearbyDestinations: nearbyFactory('Tozeur', [
    {
      name: 'Nefta',
      image: '/cover.webp',
      imageAlt: 'Location voiture Nefta avec Plany.tn – oasis et source thermale',
      link: '/location-voiture-pas-cher-a-tozeur',
...
locationDataSEO['sidi-bouzid'] = {
  ...
  nearbyDestinations: nearbyFactory('Sidi Bouzid', [
    ...
    {
      name: 'Sfax',
      image: '/location-voiture-aeroport-sfax.webp',
      imageAlt: 'Location voiture Sfax avec Plany.tn – port et zone industrielle',
      link: '/location-voiture-pas-cher-a-sfax',
...
locationDataSEO.zaghouan = {
  ...
  nearbyDestinations: nearbyFactory('Zaghouan', [
    ...
    },
    {
      name: 'El Fahs',
      image: '/cover.webp',
      imageAlt: 'Location voiture El Fahs avec Plany.tn – forêts et sites romains',
...
locationDataSEO.medenine = {
  ...
  nearbyDestinations: nearbyFactory('Médenine', [
    ...
    },
    {
      name: 'Ben Gardane',
      image: '/cover.webp',
      imageAlt: 'Location voiture Ben Gardane avec Plany.tn – marché frontalier du sud',
      link: '/location-voiture-pas-cher-a-medenine',
